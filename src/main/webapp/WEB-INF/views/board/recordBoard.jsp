        ...
        <section>
            ...
            <div class="freeboardFrame">
                ...
                <div class="paging">
                	<ul>
                		<c:if test="${pc.prev }">
                		<li><a href="/board/recordBoard?page=${pc.paging.page-1 }&countPerPage=${pc.paging.countPerPage}">이전</a>
                		</c:if>
                		
                		<c:forEach var="pageNum" begin="${pc.beginPage }" end="${pc.endPage }">
                		<li><a href="/board/recordBoard?page=${pageNum}&countPerPage=${pc.paging.countPerPage}" class="${pageNum == pc.paging.page ? 'page-active' : '' }">${pageNum }</a>
                		</c:forEach>
                		
                		<c:if test="${pc.next }">
                		<li><a href="/board/recordBoard?page=${pc.paging.page+11 }&countPerPage=${pc.paging.countPerPage}">다음</a>
                		</c:if>
                	</ul>
                </div>
