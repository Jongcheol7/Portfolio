        ...
        <section>
            ...
            <div class="freeboardFrame">
                <table>
                    ...
                    <tr id="innerTable">
                    	<td>${list.boardNo }</td>
                        <td><a href="/board/freeBoardContent?boardNo=${list.boardNo }">${list.title }</a></td>
                        <td>${list.writer }</td>
                ...
                <div class="paging">
                	<ul>
                		<c:if test="${pc.prev }">
                		<li><a href="/board/freeBoard?page=${pc.paging.page-1 }&countPerPage=${pc.paging.countPerPage}">이전</a>
                		</c:if>
                		
                		<c:forEach var="pageNum" begin="${pc.beginPage }" end="${pc.endPage }">
                		<li><a href="/board/freeBoard?page=${pageNum}&countPerPage=${pc.paging.countPerPage}" class="${pageNum == pc.paging.page ? 'page-active' : '' }">${pageNum }</a>
                		</c:forEach>
