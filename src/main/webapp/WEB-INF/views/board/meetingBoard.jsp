            ...
            <div class="freeboardFrame">
                ...
                <div class="paging">
                	<ul>
                		...
                		<c:if test="${pc.next }">
                		<li><a href="/board/meetingBoard?page=${pc.paging.page+11 }&countPerPage=${pc.paging.countPerPage}">다음</a>
                		</c:if>
                	</ul>
                </div>
...
<script>
    document.getElementById("writeBoard").addEventListener("click",function(){
        location.href = "/board/meetingBoardWrite";
    });
    ...
    $(function() {
		...
		$("#searchBtn").click(function() {
			...
			location.href = "/board/meetingBoard?keyword="+keyword+"&condition="+condition;
		});
